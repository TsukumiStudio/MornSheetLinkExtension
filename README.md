...
Googleスプレッドシートの右クリックメニューで「この範囲へのリンクを作成」の直下に「この範囲へのリンクを作成 Ex」を追加するChrome系ブラウザ用拡張です。日本語・英語のメニューに対応します。
...
4. セル範囲を選択し、右クリック →「この範囲へのリンクを作成 Ex」を選びます。通常項目がサブメニュー内にある場合は、そのサブメニューを開きます。
