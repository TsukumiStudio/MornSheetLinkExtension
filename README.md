...
- [FHD OGP画像](assets/ogp-preview.png)／[OGP用PSD](assets/source/ogp.psd)：1920×1080、6レイヤー。原稿は [SVG](assets/source/ogp.svg)、再生成は `python3 scripts/build_thumbnail.py ogp`。文字はラスターレイヤーです。
